...
int wmain(int argc, wchar_t** argv) {
    ...
    // GNU ld emits its default manifest as en-US. Keep every selectable
    // language variant identical so Windows can never choose conflicting
    // requestedExecutionLevel metadata.
